...
def load_model(filename):
    print('Loading H2O model from {}'.format(filename))
    model = h2o.load_model(filename)
    return model
...
class uniandes_config():
    def __init__(self):
        self.geoinfo = 'datos/uniandes/DescriptorUniandes.csv'
        self.excelinfo = 'datos/uniandes/Uniandes_tanda3.xlsx'
        self.filterdate = '2020-05-08'
