...
if __name__ == "__main__":
    ...
    parser.add_argument('--geoinfo', type=str, default='datos/uniandes/DescriptorUniandes.csv')
    parser.add_argument('--excelinfo', type=str, default='datos/uniandes/Uniandes_tanda3.xlsx')
    parser.add_argument('--filterdate', type=str, default='2020-05-08')
